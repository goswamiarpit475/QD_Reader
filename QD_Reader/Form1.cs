...
namespace QD_Reader
{
    public partial class Form1 : Form
    {
        ...
        private void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            Properties.Settings.Default["DefaultPrinter"] = printerList.SelectedItem;
            ...
            try
            {
                ...
                try
                {
                    ...
                    foreach (string s in job)
                    {
                        ...
                        strToPrint = createPrintNumber(s, store);
                        strToPrint = strToPrint +"\n"+ barCodeString(s, store);
        ...
        {
            //DefaultPrinter
            string dprinter=Convert.ToString(Properties.Settings.Default["DefaultPrinter"]);
            //Properties.Settings.Default.Save();
            ...
            foreach (String strPrinter in PrinterSettings.InstalledPrinters)
            {
                ...
                if (strPrinter == dprinter)
                {
                    printerList.SelectedItem = strPrinter;
                }
            }
        }
