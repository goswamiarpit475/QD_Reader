    ...
    public partial class Form1 : Form
    {
        ...
        private void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            { 
                ...
                {
                    awbText.Text = awbText.Text.Substring(awbText.Text.Length - 12);
                }
                k = dbobj.saveDataToDB(awbText.Text, textCourier.Text, job, textStore.Text, txtNote.Text, loggedInUser);
                if (k == 0)
                {
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs ev)
        {
            ...
            linesPerPage = 1;//ev.MarginBounds.Height /printFontBarCode.GetHeight(ev.Graphics);
